...
# Mostly Copied from https://pettingzoo.farama.org/tutorials/sb3/connect_four/
class SB3ActionMaskWrapper(BaseWrapper, gym.Env):
    ...
    def observation_space(self, agent):
        return super().observation_space(agent)["observation"]
...
def train_action_mask(env_fn, steps, seed, **env_kwargs):
